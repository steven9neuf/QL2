...
- Lancer l'exécutable en cliquant sur le script run.bat ou en exécutant la commande suivante `java -Djava.library.path=./lib/natives -Dlog4j.configurationFile=src/log4j.properties -jar Storm.jar`
